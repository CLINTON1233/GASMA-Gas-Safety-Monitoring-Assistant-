        ...
        <div class="w-70 gradient-bg text-white shadow-xl">
            ...
            <nav class="mt-6 px-4">
                ...
                <div class="mb-6">
                    ...
                    <a href="/pemantauan_cahaya" class="sidebar-item  flex items-center gap-3 py-3 px-4 rounded-lg mb-2">
                ...
                <div>
                    ...
                    <a href="/pengaturan_sistem" class="sidebar-item active flex items-center gap-3 py-3 px-4 rounded-lg mb-2">
